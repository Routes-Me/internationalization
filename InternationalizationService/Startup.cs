...
using InternationalizationService.Repository;
...
namespace InternationalizationService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<InternationalizationServiceContext>(options =>
            {
            ...
            services.AddScoped<INationaitiesRepository, NationalitiesRepository>();
